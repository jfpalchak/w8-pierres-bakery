...
namespace PierresBakery
{
  class Program
  {
    static void Main()
    {
      ...
      Console.WriteLine(" ---------------------------------------------");
      Console.WriteLine("|     Bread: {0:C} |    Buy 2, get 1 free!    |", Bread.Price);
      Console.WriteLine("|    Pastry: {0:C} |    Buy 3, get 1 free!    |", Pastry.Price);
      Console.WriteLine(" ---------------------------------------------");
      ...
      int breadCost = Bread.Order(breadOrder);
      int pastryOrder = int.Parse(pastryOrderString);
      int pastryCost = Pastry.Order(pastryOrder);
